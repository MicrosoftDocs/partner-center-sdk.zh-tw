...
| 國家/區域                           | ISO Alpha 2 國家/地區代碼 | ISO Alpha 3 國家/地區代碼 | 支援的文化特性                  |
|------------------------------------------|--------------------------|--------------------------|---------------------------------------|
...
| 英屬印度洋領土           | IO                       | IOT                      | zh-TW                                 |
| 英屬維爾京群島                   | VG                       | VGB                      | zh-TW                                 |
| 汶萊                                   | BN                       | BRN                      | BN/en-us                         |
...
| 賴索托                                  | LS                       | 讓 LSO                      | zh-TW                                 |
| 賴比瑞亞                                  | LR                       | LBR                      | zh-TW                                 |
| 利比亞                                    | LY                       | LBY                      | ar-去年年初/en-us                         |
| 列支敦斯登                            | LI                       | 遮蔽                      | de-l i/en-us                         |
| 立陶宛                                | LT                       | LTU                      | lt-LT/en-us                         |
| 盧森堡                               | LU                       | LUX                      | de-LU/fr-LU/en-us                 |
| 澳門特別行政區                                | MO                       | MAC                      | zh-每月/en-us                         |
...
| 巴布亞紐幾內亞                         | PG                       | PNG                      | zh-TW                                 |
| 巴拉圭                                 | PY                       | 撬                      | es-.PY/en-us                         |
| 祕魯                                     | PE                       | 依據                      | es-PE/en-us                         |
...
| 聖文森及格瑞那丁         | VC                       | VCT                      | zh-TW                                 |
| 聖巴瑟米                         | BL                       | BLM                      | fr-FR/en-us                         |
| 薩摩亞獨立國                                    | WS                       | WSM                      | zh-TW                                 |
| 聖馬利諾                               | SM                       | SMR                      | it-en-us                         |
