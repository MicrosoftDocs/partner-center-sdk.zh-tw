...
---
# <a name="get-invoice-line-items"></a>Get invoice line items
...
##### <a name="microsoft-azure-ms-azr-0145p-subscription"></a>Microsoft Azure (MS-AZR-0145P) subscription
...
##### <a name="previous-syntaxes"></a>Previous syntaxes
...
|------------------------|--------|----------|-------------------------------------------------------------------|
| invoice-id             | 字串 | [是]      | A string that identifies the invoice.                             |
| billing-provider       | 字串 | [是]      | The billing provider: "Office", "Azure", "OneTime".               |
| invoice-line-item-type | 字串 | [是]      | The type of invoice detail: "BillingLineItems", "UsageLineItems". |
| size                   | 數目 | 無       | The maximum number of items to return.                            |
| offset                 | 數目 | 無       | The zero-based index of the first line item to return.            |
| seekOperation          | 字串 | 無       | If **billing-provider** equals **OneTime**, set **seekOperation** equal to **Next** to get the next page of invoice line items. |
| hasPartnerEarnedCredit | bool | 無 | The value indicating if to return the line items with partner earned credit applied. Note: this parameter will be only applied when billing provider type is OneTime and InvoiceLineItemType is UsageLineItems. |
...
### <a name="rest-request-response-examples"></a>REST request-response examples
...
#### <a name="request-response-example-3"></a>Request-response example 3
...
##### <a name="request-example-3"></a>Request example 3
...
#### <a name="request-response-example-4"></a>Request-response example 4
...
##### <a name="request-example-4"></a>Request example 4
...
##### <a name="response-example-4"></a>Response example 4
...
#### <a name="request-response-example-5"></a>Request-response example 5

In the following example, there is paging using a continuation token. 詳細資料如下：

- **BillingProvider**: **OneTime**
- **InvoiceLineItemType**: **BillingLineItems**
- **SeekOperation**: **Next**

##### <a name="request-example-5"></a>Request example 5
...
##### <a name="response-example-5"></a>Response example 5
