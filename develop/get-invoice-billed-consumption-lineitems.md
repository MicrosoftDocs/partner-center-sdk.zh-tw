...
| invoice-line-item-type | 字串 | [是]      | The type of invoice detail: "UsageLineItems". |
| currencyCode           | 字串 | [是]      | The currency code for the billed line items.                    |
| period                 | 字串 | [是]      | The period for billed recon. example: current, previous.        |
