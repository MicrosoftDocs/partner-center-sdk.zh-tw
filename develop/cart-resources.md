...
| 錯誤                | Object                           | 在購物車建立後，如果發生錯誤，則會套用此應用程式。                                                                                                    |
...
| AssetStatusChangeNotValid | 800040 | 資產狀態無法從變更為 **{0}** **{1}** 。 |
...
| CancelLegacyOrder | 800063 | **{0}** 無法取消此順序。 使用 `PATCH /customers/{1}/subscriptions/<subscriptionId>` 來暫止訂閱。 |
| CartProcessedByAnotherRequest | 800064 | **{0}** 正在由另一個要求處理購物車。 |
