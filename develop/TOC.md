...
#### [針對合作夥伴中心註冊應用程式詳細資料](create-apps-for-partner-center-for-microsoft-national-clouds.md)
...
#### [依照合作夥伴的 MPN 識別碼取得客戶的訂用帳戶](get-all-subscriptions-by-partner.md)
...
#### [依照識別碼取得使用者帳戶](get-a-user-account-by-id.md)
...
#### [依照識別碼取得供應項目](get-an-offer-by-id.md)
#### [依照識別碼取得訂單](get-an-order-by-id.md)
...
### [推薦](https://docs.microsoft.com/partner/develop/referrals)
...
#### [依照市場取得地址格式規則](get-market-specific-validation-data.md)
...
## [合作夥伴中心的受控 API 參照](https://docs.microsoft.com/dotnet/api/?view=partnercenter-dotnet-latest)
