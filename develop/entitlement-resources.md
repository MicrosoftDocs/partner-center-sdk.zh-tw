...
|----------|------|-------------|
| id | string | 參考之順序的識別碼。 |
| lineItemId | string | 參考之訂單明細專案的識別碼。 |
| 替代識別碼 | string | 參考之訂單明細專案的替代識別碼。 |
...
| 屬性 | 類型 | 描述 |
|----------|------|-------------|
| artifactType | string | 成品的類型。 （從 SDK 1.8 中的[ArtifactType](#artifacttype)更新為字串） |
...
| resourceID | string                         | Azure 保留順序或資源的識別碼。 |
...
| 屬性          | 類型                           | 描述                                                        |
|-------------------|--------------------------------|--------------------------------------------------------------------|
| reservationId     | string                         | 保留的識別碼。                                         |
| scopeType         | string                         | 與虛擬機器保留相關聯的範圍類型。 |
| displayName       | string                         | 保留的顯示名稱。                               |
...
| provisioningState | string                         | 保留的布建狀態。                         |
