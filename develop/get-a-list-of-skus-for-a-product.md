...
| reservationScope | 字串   | No | 查詢 Azure 保留產品的 Sku 清單時，請指定 `reservationScope=AzurePlan` 以取得適用于 AzurePlan 的 sku 清單。 排除此參數，以取得適用于 Microsoft Azure （MS-AZR-0017P-流程 ms-azr-0145p）訂用帳戶的 Azure 保留產品的 Sku 清單。  |
