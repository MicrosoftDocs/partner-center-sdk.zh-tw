...
| Title            | 字串                                                                      | Y        | 服務要求標題。                                                           |
| Description      | 字串                                                                      | Y        | 描述。                                                                     |
| Severity         | 字串                                                                      | Y        | 嚴重性：「不明」、「重大」、「適中」或「最小」。                       |
...
| 備註            | [ServiceRequestNotes](service-request-resources.md#servicerequestnote)的陣列       | N        | 加入至服務要求的附注集合。                                  |
| CountryCode      | 字串                                                                      | N        | 對應至服務要求的國家/地區。                                    |
| 屬性       | 物件 (object)                                                                      | N        | 包含 "ObjectType"： "ServiceRequest"。                                             |
